...
### 简要题面
$n$个点的树，$m$个玩家，第$i$个玩家时刻 0 在$s_i$，要到达$t_i$，每个玩家都是一秒走一条边径直向终点走去，走到终点后消失。每个树节点上有一个观察员，第$j$个点的观察员会在 $w_j$时刻记录此时第$j$个点的人数，如果有人此时正好以$j$为终点且到达，那么在他消失前观察员也会记下他。问每个观察员记录的人数。
